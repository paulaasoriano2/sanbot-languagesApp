...
public class PictogramasDbAdapter {
    ...
    private static final String DATABASE_TABLE = "pictogramas";
    private static final String TAG = "PictogramasDbAdapter";
    ...
    public PictogramasDbAdapter(Context ctx) {
        this.mCtx = ctx;
    }

    public PictogramasDbAdapter open() throws SQLException {
    ...
    public Cursor fetchAllPictogramas() {
        return mDb.query(
                DATABASE_TABLE,
